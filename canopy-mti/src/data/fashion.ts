...
export const FASHION_SOURCES: Source[] = [
  {
    ...
    limitations: 'Transcribed from the published PDF. The Next Gen product marker column could not be read from the text layer and is not loaded. Capacity is a share of global MMCF capacity, not tonnes.',
...
export const FASHION_QUANTITIES: Quantity[] = [
  ...
  q({ id: 'q_mmcf_green', subjectType: 'global', subjectId: 'world', metric: 'Capacity held by green shirt producers', value: +green.toFixed(1), unit: '%', period: '2025', scope: 'World MMCF production capacity', basis: 'capacity', denominator: 'Total global MMCF capacity', status: 'calculated', sourceIds: ['src_hotbutton_2025'], formula: 'Sum of capacity shares for producers scoring 20 buttons or more', note: '22 of the 28 scored producers are green shirt.' }),
