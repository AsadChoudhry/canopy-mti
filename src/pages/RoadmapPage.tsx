import { CheckCircle2, Circle, Database, Target, Users } from 'lucide-react'
    ...
    <AppShell crumbs={[{ label: 'Year-one roadmap' }]}>
      <div className="flex flex-col gap-5">
        <div>
          ...
          <p className="text-[15px] text-slate-500 mt-1">What is built, what comes next, who owns it and which decision it changes.</p>
        </div>

        <div className="flex flex-wrap gap-4 text-[12px] text-slate-600">
          <span className="flex items-center gap-1.5"><CheckCircle2 size={14} className="text-green-600" /> Built in this prototype</span>
          <span className="flex items-center gap-1.5"><Circle size={14} className="text-slate-400" /> Proposed</span>
        </div>
