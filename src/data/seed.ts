...
export const SEED_STORE: Store = {
  version: 12,
  sources: [...SEED_SOURCES, ...METSA_SOURCES, ...FASHION_SOURCES, ...FIBRE_SOURCES, ...CANOPY_SOURCES],
  quantities: [...SEED_QUANTITIES, ...METSA_QUANTITIES, ...FASHION_QUANTITIES, ...SATERI_QUANTITIES, ...FIBRE_QUANTITIES, ...CANOPY_QUANTITIES],
