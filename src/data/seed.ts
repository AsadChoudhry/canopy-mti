...
import { RESEARCH_QUANTITIES, RESEARCH_SOURCES } from './research2026'
import { CANOPY_QUANTITIES, CANOPY_SOURCES } from './canopy'
...
export const SEED_STORE: Store = {
  version: 13,
  sources: [...SEED_SOURCES, ...METSA_SOURCES, ...FASHION_SOURCES, ...FIBRE_SOURCES, ...CANOPY_SOURCES, ...RESEARCH_SOURCES],
  quantities: [...SEED_QUANTITIES, ...METSA_QUANTITIES, ...FASHION_QUANTITIES, ...SATERI_QUANTITIES, ...FIBRE_QUANTITIES, ...CANOPY_QUANTITIES, ...RESEARCH_QUANTITIES],
