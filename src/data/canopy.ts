...
export const CANOPY_QUANTITIES: Quantity[] = [
  ...
  q({ id: 'q_pkg_nextgen_upper', subjectType: 'global', subjectId: 'world', metric: 'Next Gen fibre in packaging paper & board, upper bound', value: 8.35, unit: 'Mt', period: '2024', scope: 'World packaging paper & board', basis: 'output', denominator: 'Packaging paper & board production 277.9 Mt (FAO 2024)', status: 'calculated', sourceIds: ['src_canopy_ar_2425', 'src_fao_2024'], formula: 'Packaging Next Gen ≤ all Next Gen production in 2024 = 8.35 Mt; 8.35 / 277.9 = 3.0%', inputs: [{ label: 'Canopy: Next Gen production 2024, all applications', value: '8.35 Mt' }, { label: 'FAO: packaging paper & board 2024', value: '277.9 Mt' }], note: 'An upper bound, not an estimate. Canopy\'s 8.35 Mt covers paper, packaging and textiles together; the packaging share is not published, so the true figure is lower.' }),
