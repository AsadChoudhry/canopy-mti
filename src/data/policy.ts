...
export const RULES: Rule[] = [
  {
    ...
    what: 'General application from 12 August 2026, with individual rules phased in on their own dates. PFAS restricted in food-contact packaging from 12 August 2026. Packaging to be recyclable from 2030. Empty space in grouped, transport and e-commerce packaging capped at 50% from 1 January 2030, or three years after the implementing acts if later.',
    ...
    milestones: [
      ...
      { date: '2030-01-01', label: 'Recyclability rules; 50% empty-space cap for grouped, transport and e-commerce packaging' },
    ],
